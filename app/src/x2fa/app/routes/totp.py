...
from app.src.x2fa.app import totp_helpers
from flask import (
    Blueprint,
    abort,
    current_app,
...
from app.src.x2fa.app.models import BackupCode, TOTPSecret
...
def totp_verify_get():
    ...
    if totp_record is None or not totp_record.verified:
        from app.src.x2fa.app.routes.auth import _oidc_error_redirect
