...
from app.src.x2fa.app.config import Config, E2ETestingConfig, ProductionConfig, TestingConfig
from app.src.x2fa.app.extensions import babel, db, limiter, migrate
from app.src.x2fa.app.oidc import oauth
from app.src.x2fa.app.oidc.grants import (
...
def create_app(config_name: str = "production") -> Flask:
    ...
    # Register blueprints
    from app.src.x2fa.app.routes.auth import auth_bp
    from app.src.x2fa.app.routes.setup import setup_bp
    from app.src.x2fa.app.routes.verify import verify_bp
    from app.src.x2fa.app.routes.totp import totp_bp
    from app.src.x2fa.app.routes.backup import backup_bp
    ...
    from app.src.x2fa.app.cli import register_commands

    register_commands(app)

    # Test-only blueprint for session injection (E2E Playwright tests)
    if config_name in ("testing", "e2e"):
        from app.src.x2fa.app.routes.test_helpers import test_bp
